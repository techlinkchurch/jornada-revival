    ...
    <div className="relative flex min-h-screen flex-col bg-background">
      ...
      >
        <div className="relative z-10 mx-auto max-w-md">
          <p className="mb-3 font-script text-2xl text-ink/70">a sua jornada na</p>
          <h1 className="font-display text-6xl leading-none tracking-wider text-ink sm:text-7xl">
            REVIVAL
            <br />
            CONFERENCE
          </h1>
          <p className="mx-auto mt-4 max-w-xs text-sm font-semibold uppercase tracking-[0.18em] text-ink/70">
