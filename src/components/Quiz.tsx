    ...
    <Modal>
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-10 text-center">
        ...
        <a
          ...
          className="mt-3 flex w-full max-w-xs items-center justify-center gap-2 rounded-xl border border-[#25D366]/30 bg-[#25D366]/10 px-6 py-3 text-sm font-semibold text-[#25D366] transition-colors hover:bg-[#25D366]/20 active:scale-[0.98]"
        >
